...
def PositivesAndNegativesStreamlit(team_select, opp_select, date_select, comp_opp_select, further_df):
    if comp_opp_select != '10 Game Rolling Avg':
        ...
        overall.loc[overall['Opposition'] == 'St Louis', 'Date'] = '2023-12-08'
        overall['Date'] = pd.to_datetime(overall['Date'])
        overall['Date'] = overall['Date'].dt.strftime('%m/%d/%Y')
    ...
    elif comp_opp_select == '10 Game Rolling Avg':
        overall = getting_PSD_team_data()
        overall.loc[overall['Opposition'] == 'St Louis', 'Date'] = '2023-12-08'
        overall['Date'] = pd.to_datetime(overall['Date'])
        overall['Date'] = overall['Date'].dt.strftime('%m/%d/%Y')
        ...
        rolling_games = overall.iloc[max(0, selected_game_idx - 10):selected_game_idx]
        ...
        mean_avg['Opposition'] = '10 Game Rolling Avg'
