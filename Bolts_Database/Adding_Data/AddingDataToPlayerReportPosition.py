...
def addingDataToPlayerReportPosition():
    ...
    def load_processed_files():
        try:
            with open('Bolts_Database/Run/Position_Game.txt', 'r') as f:
    ...
    def save_processed_files(processed_files):
        with open('Bolts_Database/Run/Position_Game.txt', 'w') as f:
            f.write('\n'.join(processed_files))

    # Function to reset processed files
    def reset_processed_files():
        if os.path.exists('Bolts_Database/Run/Position_Game.txt'):
            os.remove('Bolts_Database/Run/Position_Game.txt')
            logging.info("Reset Position_Game.txt. All files will be reprocessed.")
    ...
    def process_and_insert(file_path, connection):
        try:
            ...
            expected_columns = ['Player Full Name', 'mins played', 'Team Name', 'Match Date', 'Position Tag', 'Yellow Card', 
