...
try:
    ...
    df = df[['Player Full Name', 'mins played', 'Team Name', 'Match Date', 'Position Tag', 'Yellow Card', 
             ...
             'Def Aerial Success ', 'Att 1v1', 'Efforts on Goal', 'Shot on Target',  'Hands GK', 'Unsucc Hands', 'Ground GK', 'Unsucc Ground', 
    ...
    number_columns = ['mins played', 'Yellow Card', 'Red Card', 'Goal', 'Assist',
                  ...
                  'Blocked Shot', 'Blocked Cross', 'Def Aerial Success ', 'Att 1v1', 'Unsucc cross GK',  'Hands GK', 'Unsucc Hands', 'Ground GK', 'Unsucc Ground', 
