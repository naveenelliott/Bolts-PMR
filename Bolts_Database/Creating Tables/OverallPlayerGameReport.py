...
try:
    ...
    drop_table_query = "DROP TABLE IF EXISTS player_non_position_game_report;"
    ...
    df = df[['Player Full Name', 'mins played', 'Match Date', 'Team Name', 'Yellow Card', 
    ...
    CREATE TABLE player_non_position_game_report (
    ...
    select_query = "SELECT * FROM player_non_position_game_report;"
