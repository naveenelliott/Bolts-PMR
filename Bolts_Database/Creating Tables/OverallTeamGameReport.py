...
try:
    ...
    drop_table_query = "DROP TABLE IF EXISTS team_game_report;"
    ...
    df = df[['Team Name', 'mins played', 'Match Date', 'Yellow Card', 
    ...
    select_query = "SELECT * FROM team_game_report;"
