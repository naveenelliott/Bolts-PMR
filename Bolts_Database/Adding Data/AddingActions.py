...
def load_processed_files():
    try:
        with open('Bolts_Database/processed_files_6.txt', 'r') as f:
...
def save_processed_files(processed_files):
    with open('Bolts_Database/processed_files_6.txt', 'w') as f:
        f.write('\n'.join(processed_files))

# Function to reset processed files
def reset_processed_files():
    if os.path.exists('Bolts_Database/processed_files_6.txt'):
        os.remove('Bolts_Database/processed_files_6.txt')
